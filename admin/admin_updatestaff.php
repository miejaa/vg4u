			...
			<article>
				...
				<table class="needapp">
					...
					<tr>
						...
						<td>
							<button class="sah"><a href="admin_updatestaffs.php?user_id=<?php echo $row['user_id']?>">Update</a></button>
							<button class="reject"><a href="includes/admin_deletestaff.php?user_id=<?php echo $row['user_id']?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a></button>
						</td>
					</tr>
					<?php
						}}
