		...
		<section>
			<article>
				...
				<table class="needapp">
			        ...
			        $sql="SELECT b.suggestion_details, b.suggestion_date, a.username FROM users a, suggestion b WHERE a.user_id = b.user_id ORDER BY suggestion_date DESC";
					...
					<tr>
						<td><?php echo ++$no; ?></td>
						<td><?php echo $row['suggestion_details']; ?></td>
