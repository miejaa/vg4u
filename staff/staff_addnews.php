	...
	<body>
		...
		<section>
			<article>
				...
				<div class="add">
					<form method="post"action="includes/staff_addnewsaction.php"  enctype="multipart/form-data" >
						<br>
						<center>
						...
						<label for="news_title">Title</label><br>
					  	<input type="text" id="news_title" name="news_title" required><br><br>
					  	<label for="news_desc">Details</label><br>
					  	<textarea id="news_desc" name="news_desc" rows="4" cols="50" required></textarea><br><br>
						...
						<input type="file" id="actual-btn" accept="image/gif, image/jpeg, image/png" onchange="loadFile(event)" name="fileToUpload" hidden/>
