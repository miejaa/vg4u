					...
					<div class="column">
						<div class="container">
							<center>
								<div>
								<?php
								 $query="SELECT donation_id FROM donation WHERE user_id='".$_SESSION['user_id']."'";
					...
					<div class="column">
						<div class="container">
							<center>
								<div>
								<?php
								 $query="SELECT news_id FROM news WHERE user_id='".$_SESSION['user_id']."'";
								 $query_run=mysqli_query($conn,$query);
								 $row=mysqli_num_rows($query_run);
								 echo"<h1>" .$row. "</h1>";
					...
					<div class="column">
						<div class="container">
							<center>
								<div>
								<?php
								 $query="SELECT ngo_id FROM ngo WHERE user_id='".$_SESSION['user_id']."'";
								 $query_run=mysqli_query($conn,$query);
								 $row=mysqli_num_rows($query_run);
								 echo"<h1>" .$row. "</h1>";
