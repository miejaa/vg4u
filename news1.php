	...
	<body>
		<nav>
			<div class="topnav" id="myTopnav">
				...
				<a style="float: right" type="button" class="logoutbtn" onclick="window.location.href='includes/logout.php'">Log Out</button></a> <a style="float: right" href="profile.php"><?php echo $_SESSION["username"]; ?></a>
			</div>
		</nav>
		<section>
			<article>
				<div class="container1">
					...
					<br><br>
					<h1>News</h1>
					<p>Virtual Gift4U shares updates about the current news related to COVID-19 by region in Malaysia.</p>
				</div>
				<div class="news">
                <div class="main">
